...
async def get_soft_deleted_stats(
    ...
    """获取各表软删除记录统计"""
    tables = ["part_masters", "part_revisions", "documents", "bom_items", "ecrs", "ecos", "configuration_items"]
    stats = {}
...
async def purge_soft_deleted(
    ...
    allowed_tables = {"part_masters", "part_revisions", "documents", "bom_items", "ecrs", "ecos", "configuration_items"}
    for tbl in tables:
    ...
    purge_order = ["bom_items", "ecos", "ecrs", "configuration_items", "documents", "part_revisions", "part_masters"]
