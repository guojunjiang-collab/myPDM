        ...
        <table className="w-full">
          <thead className="bg-[var(--ui-bg-subtle)] border-b border-[var(--ui-border)] sticky top-0 z-10">
            <tr>
              ...
              <th onClick={() => onSort('created_at')} className="w-44 px-2 py-3 text-center text-sm font-medium text-[var(--ui-text-secondary)] cursor-pointer select-none whitespace-nowrap">
                创建时间{sortIcon('created_at')}
              </th>
              <th onClick={() => onSort('version')} className="w-16 px-4 py-3 text-center text-sm font-medium text-[var(--ui-text-secondary)] cursor-pointer select-none whitespace-nowrap">
                版本{sortIcon('version')}
              </th>
              <th onClick={() => onSort('type')} className="w-20 px-4 py-3 text-center text-sm font-medium text-[var(--ui-text-secondary)] cursor-pointer select-none whitespace-nowrap">
                类型{sortIcon('type')}
              </th>
              <th onClick={() => onSort('status')} className="w-20 px-4 py-3 text-center text-sm font-medium text-[var(--ui-text-secondary)] cursor-pointer select-none whitespace-nowrap">
                状态{sortIcon('status')}
              </th>
              <th onClick={() => onSort('check_out_user_name')} className="w-20 px-4 py-3 text-center text-sm font-medium text-[var(--ui-text-secondary)] cursor-pointer select-none whitespace-nowrap">
