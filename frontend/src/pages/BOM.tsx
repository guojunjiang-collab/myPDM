...
import { bomApi, assembliesApi, partsApi, documentsApi, customFieldsApi } from '../services/api';
                        ...
                        {(docTraceResult.references || []).map((ref: any, idx: number) => {
                          ...
                          return (
                            <tr
                              ...
                              className="hover:bg-gray-50 cursor-pointer"
                              onClick={() => handleViewEntity(isPart ? 'part' : 'assembly', ref.entity_id)}
                            >
                              <td className="px-3 py-2">
