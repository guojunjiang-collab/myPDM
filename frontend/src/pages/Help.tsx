...
const sections: Section[] = [
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <Steps
          items={[
            <>在登录页底部点击 <K>飞书登录</K> 或 <K>飞书登录（EH）</K> 按钮。</>,
  ...
  },
  {
    ...
    body: (
      <>
        <P>已登录用户可将自己的系统账号与飞书身份绑定，此后通过该飞书入口登录将直接进入当前账号。</P>
        <H>绑定飞书</H>
        <Steps
          items={[
            <>进入 <K>系统设置 → 飞书绑定</K> 页面。</>,
            <>页面会显示已配置的飞书入口（如「飞书登录」「飞书登录（EH）」）。</>,
        ...
        <UL
          items={[
            <>
              若飞书身份已绑定到 <K>guest（访客）</K> 账号，绑定到新账号时会自动停用旧访客账号。
            </>,
            <>
              若飞书身份已绑定到其他正式账号（非 guest），绑定将被<strong>拒绝</strong>，需先由原账号解绑。
            </>,
          ]}
        />
      </>
