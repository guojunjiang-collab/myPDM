...
const sections: Section[] = [
  ...
  },
  {
    ...
    body: (
      <>
        <P>集中查看与分析 BOM（物料清单）结构的工具，包含两个子页签：</P>
        <UL
          items={[
            <>
              <K>BOM 树</K>：以树形展开某个部件的完整层级结构，逐级查看子件、用量等；点击行可打开零部件详情。
            </>,
            <>
              <K>BOM 对比</K>：选择两个对象（或两个版本）对比差异，直观看到新增、删除、变更的条目。
            </>,
          ]}
        />
      </>
