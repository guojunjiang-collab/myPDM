            ...
            <table className="w-full text-sm">
              <thead className="bg-[var(--ui-bg-subtle)] border-b sticky top-0 z-10">
                <tr>
                  ...
                  <th onClick={() => handleViewSort('code')} className="px-3 py-2 text-left text-[var(--ui-text-secondary)] font-medium cursor-pointer select-none whitespace-nowrap">件号 {getViewSortIcon('code')}</th>
                  ...
                  <th onClick={() => handleViewSort('version')} className="px-3 py-2 text-left text-[var(--ui-text-secondary)] font-medium w-24 cursor-pointer select-none whitespace-nowrap">版本 {getViewSortIcon('version')}</th>
                  <th onClick={() => handleViewSort('status')} className="px-3 py-2 text-left text-[var(--ui-text-secondary)] font-medium w-24 cursor-pointer select-none whitespace-nowrap">状态 {getViewSortIcon('status')}</th>
